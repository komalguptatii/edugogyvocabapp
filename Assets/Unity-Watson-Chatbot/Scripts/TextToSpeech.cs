...
public class TextToSpeech : MonoBehaviour
{
    ...
    public enum IBM_voices
    {
        ...
        Dutch_Belgian_Female_Adele,
        Dutch_Netherlands_Female_Emma,
        Dutch_Netherlands_Male_Liam,
    ...
    public Hashtable voiceTable = new Hashtable
    {
        ...
        {IBM_voices.Dutch_Belgian_Female_Adele, "nl-BE_AdeleVoice"},
        {IBM_voices.Dutch_Netherlands_Female_Emma, "nl-NL_EmmaVoice"},
        {IBM_voices.Dutch_Netherlands_Male_Liam, "nl-NL_LiamVoice"},
    ...
    private void Start()
    {
        ...
        //     speakerButton.OnClick.AddListener(delegate{AddTextToQueue(word.text);});
    ...
    public IEnumerator CreateService()
    {
        ...
        // Debug.Log(settings.tts_apikey);
        // Debug.Log(settings.tts_serviceUrl);
        //  Wait for tokendata
        ...
        if (!string.IsNullOrEmpty(settings.tts_serviceUrl))
        {
            ...
            // Debug.Log(tts_service.defaultServiceUrl);
        }
    }
